...
const MatchResultModalContent = styled.div`
  text-align: center;
  padding: 10px;
`;

function MatchResultModal({ openModal, ranking, name, time }) {
  // Ranking, name, time
  const [countdownTime, setCountdownTime] = useState(
    TIME.RANKING_DURATION_TIME
  );
  ...
  return (
    ...
    <MatchResultModalLayout className="matchresult-modal">
